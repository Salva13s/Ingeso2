...
const Login = ({ onStudentLogin, onTeacherLogin }:any) => {
  ...
  return (
    ...
    <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
      <div className="bg-[#A90429] absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 md:p-8">
      ...
      <form className="p-12 md:p-24">
        ...
        <button className="bg-[#03102C] font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
      </form>
    </div>
   </div>
  );
